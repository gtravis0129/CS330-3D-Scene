...
private:
	...
	// STUDENT: Milestone Two object
	void DrawHeater(const glm::vec3& positionXYZ);

	// Draw the basket on top of heater
	void DrawBasket(const glm::vec3& positionXYZ);

	// Draw Noise maker
	void DrawNoiseMaker(const glm::vec3& positionXYZ);

	//Draw the fan 
	void DrawFan(const glm::vec3& positionXYZ);
